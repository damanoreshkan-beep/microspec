...
// microspec: the only local edit to this vendored file (k2-fsa/sherpa-onnx, MIT). `class OfflineRecognizer`
// is a LEXICAL global — an ES module (apps/tgvoice/stt.js) that loads this as a classic <script> cannot
// reach it via globalThis, unlike the `function`s and `var SherpaOnnx`. This publishes it so stt.js can.
try { globalThis.OfflineRecognizer = OfflineRecognizer; } catch (e) { /* non-browser */ }
