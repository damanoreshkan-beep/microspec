...
<img src="icon.svg" width="84" height="84" alt="Prox">

# Prox

**Побач, що кожен телефон навколо тихо транслює, щоб спаруватись**
...
**Screens** Ефір · Передавач  ·  **Capabilities** —  ·  **Offline** yes  ·  **Installable** yes
