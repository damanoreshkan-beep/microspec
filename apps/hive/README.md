...
<img src="icon.svg" width="84" height="84" alt="Соти">

# Соти

**Кожне радіо навколо тебе — окремою коміркою**
...
**Screens** Соти · Список · Пошук · Вартовий  ·  **Capabilities** —  ·  **Offline** yes  ·  **Installable** yes
