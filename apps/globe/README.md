...
<img src="icon.svg" width="84" height="84" alt="Глобус">

# Глобус

**Інтерактивний глобус — крути Землю, обирай країни та дивись факти**
...
**Screens** Земля · МКС · Землетруси  ·  **Capabilities** —  ·  **Offline** yes  ·  **Installable** yes
