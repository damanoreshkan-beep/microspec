...
[![live demo](https://img.shields.io/badge/live-33%20apps-3fb950)](https://damanoreshkan-beep.github.io/microspec/store/)
[![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

> **▶ Try the farm live:** **[33 installable apps](https://damanoreshkan-beep.github.io/microspec/store/)** —
...
The 33-app farm is the proof, and doubles as the regression suite for the runtime itself.
...
…plus 28 more (`hn · rates · crypto · quakes · iss · launches · transit · sun · kp · globe · dou · …`).
...
| `apps/` | the reference farm: 33 apps = family showcase + runtime regression suite |
