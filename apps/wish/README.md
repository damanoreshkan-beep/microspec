...
<img src="icon.svg" width="84" height="84" alt="Список бажань">

# Список бажань

**Список бажань — кілька списків, ціни й пріоритети, повний офлайн; дані лишаються на пристрої**
...
**Screens** Списки  ·  **Capabilities** —  ·  **Offline** yes  ·  **Installable** yes
