...
[![live demo](https://img.shields.io/badge/live-44%20apps-3fb950)](https://damanoreshkan-beep.github.io/microspec/store/)
[![built on Android](https://img.shields.io/badge/built%20on-Termux%20%2F%20Android-a78bfa)](#-written-on-a-phone)
[![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

### **[▶ Open the farm — 44 installable apps](https://damanoreshkan-beep.github.io/microspec/store/)**
...
No laptop. No desktop. The runtime, the gates, and all 44 apps were written and shipped from **Termux on
...
The 44-app farm is the proof, and doubles as the regression suite for the runtime itself.
...
| `apps/` | the reference farm: 44 apps = family showcase + runtime regression suite |
