...
// RULERS moved to signif.js — this file draws glyphs and imports htm/preact for it, so anything that has to
// be reachable from a bare `deno test` cannot live here. Rulership is a signification and it now sits with
// the rest of them, where dignityOf() derives detriment and fall from it.
