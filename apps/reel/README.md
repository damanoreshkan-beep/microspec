...
<img src="icon.svg" width="84" height="84" alt="Reel">

# Reel

**Встав будь-який URL сторінки — і кожне відео на ній стає повноекранною стрічкою, що гортається сама; наступні сторінки підвантажуються, поки ти свайпаєш.**
...
**Screens** Стрічка · Лайки · Джерела  ·  **Capabilities** —  ·  **Offline** yes  ·  **Installable** yes
