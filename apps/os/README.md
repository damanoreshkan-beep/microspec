...
<img src="icon.svg" width="84" height="84" alt="microspec OS">

# microspec OS

**Що цей пристрій дозволяє застосунку**
...
**Screens** Пристрій · Радар · Файли · Сигнали  ·  **Capabilities** —  ·  **Offline** yes  ·  **Installable** yes
