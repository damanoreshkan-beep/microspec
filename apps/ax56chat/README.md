...
<img src="icon.svg" width="84" height="84" alt="AX56 Чат">

# AX56 Чат

**Чат поза мережею через сире Wi-Fi — без інтернету й роутера, лише RTL8852AU і ті, хто поруч**
...
**Screens** Кімната · Поруч · Інженер · Журнал  ·  **Capabilities** —  ·  **Offline** yes  ·  **Installable** yes
