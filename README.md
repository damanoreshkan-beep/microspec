...
No laptop. No desktop. The runtime, the gates, and all 70 apps were written and shipped from **Termux on
...
The 70-app farm is the proof, and doubles as the regression suite for the runtime itself.
...
| `apps/` | the reference farm: 70 apps = family showcase + runtime regression suite |
